...
('geolocation-trigger', 'trigger', 'Location', 'Geolocation', 'Trigger based on visitor geographic location and network details', 'MapPin',
 '{"geoField": "country", "operator": "equals", "values": ""}',
 '[{"key": "geoField", "type": "select", "label": "Geographic Field", "required": true, "options": [{"value": "country", "label": "Country (e.g., India, United States)"}, {"value": "countryCode", "label": "Country Code (e.g., IN, US)"}, {"value": "region", "label": "Region/State (e.g., Maharashtra, California)"}, {"value": "city", "label": "City (e.g., Mumbai, New York)"}, {"value": "timezone", "label": "Time Zone (e.g., Asia/Kolkata)"}, {"value": "isp", "label": "ISP/Organization (e.g., Airtel Broadband)"}, {"value": "ipType", "label": "IP Type (Residential, Business, Mobile)"}], "description": "Choose which geographic or network parameter to evaluate"}, {"key": "operator", "type": "select", "label": "Condition", "required": true, "options": [{"value": "equals", "label": "Equals (exact match)"}, {"value": "contains", "label": "Contains (partial match)"}, {"value": "excludes", "label": "Does not equal"}, {"value": "exists", "label": "Has any value"}], "description": "How to compare the visitor location data"}, {"key": "values", "type": "textarea", "label": "Target Values", "required": true, "placeholder": "India\\nUnited States\\nCanada", "description": "List of target values (one per line or comma-separated)"}]'
),
-- More action nodes
